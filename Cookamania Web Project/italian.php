...
cuisine_main.html">CUISINES <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
...
<div style = "background-color: #a2424f">
	<div class="container-fluid">
		<div class="row">

      <div class="col-md-12 main" style="color:white;"><p>&nbsp</p><p>&nbsp</p><p>&nbsp</p><p>&nbsp</p><h1>Italian cuisine</h1></div>
      <?php
      $i=0;
      ...
      echo "<div class='row'>
        ...
        <div class='col-md-5' style='margin-top: 10px;'> <a href='recipes.php?id=$rno&rc=$rcuisine''> <img class='img-responsive x' src='$img' width='100%' height='55%''></a> </div>
        <div class='col-md-4 rel' style ='height: 50%;'>
        	<h1>$rname</h1>
          <hr><br>
        	<p>$desc</p>
        </div>
      ...
      echo "<div class='row'>
        <div class='col-md-1'>  </div>
        <div class='col-md-4 rel1' style ='height: 50%;'>
        	<h1> $rname </h1>
          <hr><br>
        	<p>$desc</p>
        </div>
