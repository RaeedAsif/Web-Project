...
$dquery = "SELECT * FROM desi";

$result = mysqli_query($mysqli, $rquery);
...
<div class="container-fluid feed" style=" padding: 100px; padding-top: 0px">
  ...
  <?php 
    while($res = mysqli_fetch_array($result)) {     
      ...
      echo "<div class='row mtop'><div class='story' style='width:100%;'><div class='ptop'><a href='#'><img src= '$img' width='100%' height='500px'></a></div>
          <br>
    ...
    <div class="row">
      ...
      <div class="member"  style="margin-top: 10px; width : 100%; padding-bottom: 20px " >
        <h4 class="font-weight-italic text-dark"> &nbsp Blog</h4>
          <br>
          <div > <a href="#"> <p>How to chop like a pro </p></a> </div>
          <hr width="80%">
          <div> <a href="#"> <p>Why is oily food bad for your health </p></a></div>       
      </div>
    </div>
